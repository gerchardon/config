...
override_git_prompt_colors() {
  ...
  GIT_PROMPT_START_USER="\[\e]0;\w\a\]_LAST_COMMAND_INDICATOR_ ${Yellow}${PathShort}${ResetColor}"
  # GIT_PROMPT_START_ROOT="_LAST_COMMAND_INDICATOR_ ${GIT_PROMPT_START_USER}"
  GIT_PROMPT_START_ROOT="\[\e]0;\w\a\]_LAST_COMMAND_INDICATOR_ ${GIT_PROMPT_START_USER}"
